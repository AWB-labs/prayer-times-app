# Emil Kowalski — Combined Skills

> A single-file compilation of the design & animation skills authored by Emil Kowalski (animations.dev).
> Combined on 2026-08-05. Each section below is the full `SKILL.md` of one skill, verbatim.

## Contents

1. [emil-design-eng](#emil-design-eng)
2. [animation-vocabulary](#animation-vocabulary)
3. [apple-design](#apple-design)
4. [find-animation-opportunities](#find-animation-opportunities)
5. [improve-animations](#improve-animations)
6. [review-animations](#review-animations)
7. [prototype](#prototype)
8. [pick-ui-library](#pick-ui-library)
