        ...
        {hasHoliday && (
          <View
            style={{
              ...
              backgroundColor: isSelected ? theme.accentFg : '#34d399',
              marginTop: 2,
            }}
          />
        )}
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            >
              ...
              {selectedDay.hijri.holidays.length > 0 && (
                <View style={{ marginTop: 12 }}>
                  <Text style={{ color: '#34d399' + 'bb', fontSize: 11, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.8 }}>
                    Islamic Event
                  </Text>
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                    {selectedDay.hijri.holidays.map((h) => (
                      ...
                      >
                        ...
                        <Text style={{ color: '#34d399', fontSize: 12, fontWeight: '500' }}>{h}</Text>
                      </View>
                    ))}
                  </View>
                </View>
            ...
            return (
              <View style={{ marginHorizontal: 16, marginTop: 16, marginBottom: 8 }}>
                ...
                {holidays.map((h, i) => (
                  ...
                  >
                    <View style={{ width: 8, height: 8, borderRadius: 4, backgroundColor: '#34d399', marginRight: 12 }} />
                    <View style={{ flex: 1 }}>
                      <Text style={{ color: theme.text, fontSize: 14, fontWeight: '500' }}>{h.label}</Text>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 16, marginTop: 12, marginBottom: 24, gap: 12 }}>
            {[
              ...
              { color: '#34d399', label: 'Islamic event' },
            ].map((item) => (
